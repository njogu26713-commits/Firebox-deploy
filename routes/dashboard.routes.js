...
router.get('/app/home',          requirePageAuth, (req, res) => res.sendFile(views('user-app.html')));
router.get('/app/projects',       requirePageAuth, (req, res) => res.redirect('/app/home#projects'));
router.get('/app/source-control', requirePageAuth, (req, res) => res.redirect('/app/home#source'));
router.get('/app/history',        requirePageAuth, (req, res) => res.redirect('/app/home#history'));
router.get('/app/deploy',         requirePageAuth, (req, res) => res.redirect('/app/home#deploy'));
router.get('/app/settings',       requirePageAuth, (req, res) => res.redirect('/app/home#settings'));
