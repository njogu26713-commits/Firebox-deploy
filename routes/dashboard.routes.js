...
const { requireUserPageAuth } = require('../middleware/user-auth.middleware');
...
router.get('/user',          requireUserPageAuth, (req, res) => res.sendFile(views('user-app.html')));
router.get('/login',         (req, res) => {
  if (config.authDisabled || req.session.userId) return res.redirect('/dashboard');
  res.sendFile(views('login.html'));
});

router.get('/home',              requireUserPageAuth, (req, res) => res.sendFile(views('user-app.html')));
...
router.get('/app',              requireUserPageAuth, (req, res) => res.redirect('/app/home'));
router.get('/app/home',          requireUserPageAuth, (req, res) => res.sendFile(views('user-app.html')));
router.get('/app/projects',       requireUserPageAuth, (req, res) => res.redirect('/app/home#projects'));
router.get('/app/source-control', requireUserPageAuth, (req, res) => res.redirect('/app/home#source'));
router.get('/app/history',        requireUserPageAuth, (req, res) => res.redirect('/app/home#history'));
router.get('/app/deploy',         requireUserPageAuth, (req, res) => res.redirect('/app/home#deploy'));
router.get('/app/settings',       requireUserPageAuth, (req, res) => res.redirect('/app/home#settings'));
